...
itens_moderador = ['Deletar conta', 'Visualizar todas as contas (Gerar .json)', 'Finalizar programa']
                                ...
                                match opc_deletar:
                                    case 1:
                                        while True:
                                            ...
                                            if delete_bd('usuario', email):
                                                break
                                        break
                                    case 2:
                                        while True:
                                            cpf = validacoes('CPF')
                                            if delete_bd('especialista', cpf):
                                                break
                                        break
                                    case _:
                                        exibir_erro()
